  ...
  $(document).ready(function () {
    ...
    $(window).scroll(function () {
      ...
      scrollLink.each(function () {
        ...
        if (offset) {
          var sectionOffset = offset.top - 105;
...
=============================================*/
    ...
    const address = $('.banner-address span').text();
    if (address) {
  ...
  var countdownElement = $('.countdown-text');
  var endDate = new Date('2023-07-16T00:00:00');
  ...
  function updateCountdown() {
    ...
    if (remainingTime <= 0) {
      ...
      countdownElement.html('countdown ends');
    }
  }
